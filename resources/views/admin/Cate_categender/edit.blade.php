                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="category_id">
                        ...
                        @foreach ($category as $cate)
                             <option value="{{$cate->id}}" {{($cate->id==$categorygender->category_id)?"selected":""}} >{{$cate->name}}</option>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="category_gender_id">
                        @foreach ($categender as $categ)
                             <option value="{{$categ->id}}" {{($categ->id==$categorygender->category_gender_id)?"selected":""}} >{{$categ->name}}</option>
