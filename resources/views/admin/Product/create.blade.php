                            ...
                            <form id="quickForm" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="mahang" class="form-control" placeholder="Mã Sản Phẩm">
                                        @error('mahang')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="Tên Product">
                                        @error('name')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="desription" id="" cols="30" rows="5"class="form-control"placeholder="Desription"></textarea>
                                        @error('desription')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="brand">
                                            @foreach ($brand as $brandr)
                                                {{-- <option value="{{$brand->id}}" {{($brand->id==$brand->brand)?"selected":""}} >{{$brand->name}}</option> --}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="danhmuc">
                                            @foreach ($category as $cate)
                                                {{-- <option value="{{$cate->id}}" {{($cate->id==$cate->danhmuc)?"selected":""}} >{{$cate->name}}</option> --}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <div><input style="margin-right: 10px" value="1" type="radio"
                                                    name="tinhtrang_id" placeholder="Còn Hàng"><label for="">Còn
                                                    Hàng</label></div>
                                            <div><input style="margin-right: 10px" value="0" type="radio"
                                                    name="tinhtrang_id" placeholder="Hết Hàng"><label for="">Hết
                                                    Hàng</label></div>
                                        </div>
{{--                                        @error('tinhtrang_id')--}}
{{--                                        <span class="text-danger">{{ $message }}</span>--}}
