                                ...
                                <div class=" col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="display_name" class="form-control"
                                            placeholder="Dispaly_name" value="{{$role->display_name}}">
                                        @error("display_name")
                                        <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                            ...
                                            @foreach ($item->pomissionchidrent as $item)
                                                ...
                                                <div class="  " style="max-width: 18rem;">
                                                    ...
                                                    <div class="card-body" ><input
                                                      {{$permissionchecket->contains("id",$item->id)?"checked":""}}
                                                      type="checkbox" value="{{$item->id}}" name="permission_id[]" style="margin-right: 6px"><span>{{$item->name}}</span></div>
