...
<head>
    ...
    <link rel='stylesheet' id='elementor-pro-css'
        ...
        media='all' />
    <link rel='stylesheet' id='elementor-post-925-css'
        href='https://fullkit.moxcreative.com/kidzoutfit/wp-content/uploads/sites/10/elementor/css/post-925.css?ver=1674896400'
        media='all' />
    ...
    <link rel="stylesheet"
        href="https://fullkit.moxcreative.com/kidzoutfit/wp-content/plugins/elementor-pro/assets/css/widget-woocommerce.min.css">
    <div class="elementor-menu-cart__wrapper">

        <link rel="canonical"
            href="https://fullkit.moxcreative.com/kidzoutfit/?elementor_library=kidzoutfit-v1-cart-page" />
        <link rel='shortlink' href='https://fullkit.moxcreative.com/kidzoutfit/?p=925' />
        <link rel="alternate" type="application/json+oembed"
            href="https://fullkit.moxcreative.com/kidzoutfit/wp-json/oembed/1.0/embed?url=https%3A%2F%2Ffullkit.moxcreative.com%2Fkidzoutfit%2F%3Felementor_library%3Dkidzoutfit-v1-cart-page" />
        <link rel="alternate" type="text/xml+oembed"
            href="https://fullkit.moxcreative.com/kidzoutfit/wp-json/oembed/1.0/embed?url=https%3A%2F%2Ffullkit.moxcreative.com%2Fkidzoutfit%2F%3Felementor_library%3Dkidzoutfit-v1-cart-page&#038;format=xml" />
        <noscript>
            <style>
...
<body
    class="elementor_library-template-default single single-elementor_library postid-925 theme-hello-elementor woocommerce-no-js elementor-default elementor-kit-98 elementor-page elementor-page-925 elementor-page-925">
    ...
    @section('content')
        ...
        <div data-elementor-type="single-page" data-elementor-id="925"
            class="elementor elementor-925 elementor-location-single post-58 post type-post status-publish format-standard has-post-thumbnail hentry category-insight tag-fashion tag-kids tag-outfit">
            <section
                class="elementor-section elementor-top-section elementor-element elementor-element-e8d81ae elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                data-id="e8d81ae" data-element_type="section"
                data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                <div class="elementor-container elementor-column-gap-default">
                    <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-e04444b"
                        data-id="e04444b" data-element_type="column">
                        <div class="elementor-widget-wrap elementor-element-populated">
                            <div class="elementor-element elementor-element-627832f elementor-widget elementor-widget-heading"
                                data-id="627832f" data-element_type="widget" data-widget_type="heading.default">
                            ...
                            <div class="elementor-element elementor-element-7a17520 elementor-invisible elementor-widget elementor-widget-heading"
                                data-id="7a17520" data-element_type="widget"
                                data-settings="{&quot;_animation&quot;:&quot;rubberBand&quot;}"
                                data-widget_type="heading.default">
                                <div class="elementor-widget-container">
                                    <h2 class="elementor-heading-title elementor-size-default">Cart Page</h2>
                                </div>
                            </div>
                            <div class="elementor-element elementor-element-8b9c66d elementor-widget-divider--separator-type-pattern elementor-widget-divider--view-line elementor-widget elementor-widget-divider"
                                data-id="8b9c66d" data-element_type="widget" data-widget_type="divider.default">
                                <div class="elementor-widget-container">
                                    <style>
                                        /*! elementor - v3.14.0 - 26-06-2023 */
            ...
            <section
                class="elementor-section elementor-top-section elementor-element elementor-element-f98a488 elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                data-id="f98a488" data-element_type="section">
                <div class="elementor-container elementor-column-gap-default">
                    <div class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-7350ddd"
                        data-id="7350ddd" data-element_type="column">
                        <div class="elementor-widget-wrap elementor-element-populated">
                            <div class="elementor-element elementor-element-f0fa5a2 e-cart-layout-two-column elementor-widget elementor-widget-woocommerce-cart"
                                data-id="f0fa5a2" data-element_type="widget" data-widget_type="woocommerce-cart.default">
                                <div class="elementor-widget-container">
                                                            ...
                                                            <tbody>
                                                                    ...
                                                                    <tr class="woocommerce-cart-form__cart-item cart_item">
                                                                        ...
                                                                        <td class="product-remove">
                                                                            <a href="/delete/{{$item->id}}"
                                                                                class="remove"
                                                                                aria-label="Remove Blue Washed Jeans from cart"
                                                                                data-product_id="86"
                                                                                data-product_sku="00012345KO-08">&times;</a>
                                                                        </td>

                                                                        <td class="product-thumbnail">
                                                                            <a href="detail_product/{{ $item->id }}"><img
                                                                        ...
                                                                        <td class="product-name" data-title="Product">
                                                                            <a
                                                                                href="detail_product/{{ $item->id }}">{{ $item->name }}</a>
                                                                        </td>
                                                                        ...
                                                                        <td class="product-quantity"
                                                                            ...
                                                                            <div class="quantity">
                                                                                <label class="screen-reader-text"
                                                                                    for="quantity_64c4eb3d3fd66">{{ $item->name }}</label>
                                                                                <input type="number"
                                                                                    class="input-text qty text" name="num_product[{{$item->id}}]" value="{{ $carts[$item->id] }}" />
                                                                            </div>
                                                                        </td>
                                                                ...
                                                                <tr>
                                                                    <td colspan="6" class="actions">
                                                                        ...
                                                                        <input formaction="/update_to_card" type="submit"
                                                                            class="button" value="Update Cart">


                                                                        {{-- <input type="hidden" id="woocommerce-cart-nonce"
                                                                            name="woocommerce-cart-nonce"
                                                                            value="e1b6eb2339" /><input type="hidden"
                                                                            name="_wp_http_referer"
                                                                            value="/kidzoutfit/?elementor_library=kidzoutfit-v1-cart-page" /> --}}
                                                                    </td>
                                                    ...
                                                    <div class="coupon e-cart-section shop_table">
                                                        <div class="form-row coupon-col">
                                                            ...
                                                            <div class="coupon-col-end">
                                                                <button class="button e-apply-coupon" name="apply_coupon"
                                                                    type="submit" value="Apply coupon">Apply
                                                                    coupon</button>
                                                            </div>
                                                        </div>
                                                    </div>
            ...
            <section
                class="elementor-section elementor-top-section elementor-element elementor-element-fb05397 elementor-section-boxed elementor-section-height-default elementor-section-height-default"
                data-id="fb05397" data-element_type="section"
                data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                <div class="elementor-background-overlay"></div>
                <div class="elementor-container elementor-column-gap-default">
                    <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-e8ebead"
                        data-id="e8ebead" data-element_type="column"
                        data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
                        <div class="elementor-widget-wrap elementor-element-populated">
                            <div class="elementor-background-overlay"></div>
                            <div class="elementor-element elementor-element-3454464 elementor-widget elementor-widget-spacer"
                                data-id="3454464" data-element_type="widget" data-widget_type="spacer.default">
                                <div class="elementor-widget-container">
                                    <style>
                                        /*! elementor - v3.14.0 - 26-06-2023 */
                    ...
                    <div class="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-fb56f44"
                        data-id="fb56f44" data-element_type="column">
                        <div class="elementor-widget-wrap elementor-element-populated">
                            <div class="elementor-element elementor-element-e1a00e5 elementor-widget__width-auto elementor-absolute e-transform e-transform elementor-invisible elementor-widget elementor-widget-image"
                                data-id="e1a00e5" data-element_type="widget"
                            ...
                            <div class="elementor-element elementor-element-d5708f9 elementor-widget__width-auto elementor-absolute e-transform e-transform elementor-invisible elementor-widget elementor-widget-image"
                                data-id="d5708f9" data-element_type="widget"
                            ...
                            <div class="elementor-element elementor-element-7ff3ce9 elementor-widget elementor-widget-heading"
                                data-id="7ff3ce9" data-element_type="widget" data-widget_type="heading.default">
                                <div class="elementor-widget-container">
                                    <h2 class="elementor-heading-title elementor-size-default">Additional discount up to
                                        30% for your first purchase</h2>
                                </div>
                            </div>
                            <div class="elementor-element elementor-element-6c22158 elementor-widget elementor-widget-text-editor"
                                data-id="6c22158" data-element_type="widget" data-widget_type="text-editor.default">
                                <div class="elementor-widget-container">
                                    <style>
                                        /*! elementor - v3.14.0 - 26-06-2023 */
                            ...
                            <div class="elementor-element elementor-element-4a6c3eb elementor-mobile-align-center elementor-widget elementor-widget-button"
                                data-id="4a6c3eb" data-element_type="widget" data-widget_type="button.default">
                                <div class="elementor-widget-container">
